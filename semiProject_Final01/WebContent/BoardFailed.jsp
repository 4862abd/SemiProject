...
<body>
	...
	<section style="padding: 20px;">
		<div class="insComplete">
			<h3><span class="fas fa-dizzy">&nbsp;수정 및 삭제 실패!</span></h3>
			<p style="color: gray;">비밀번호 확인 요망</p>
			<br>
			<ul class="nav" style="padding: 40px;">
				<li><a href="main.jsp" style="color: white;"><span class="fas fa-home">&nbsp;메인 페이지로 이동</a></li>
				<br>
				<li><a href="/semiProject_Final/boardListCon.do" style="color: white;"><span class="	fas fa-chalkboard">&nbsp;게시판 목록으로 이동</a></li>
			</ul>
		</div>
	</section>
