...
<body>
	...
	<center style="margin-top: 70px">
		<h2> 게시글 수정</h2>
		<form action="/semiProject_Final/boardUpdateProcCon.do" method ="post" id="frm">
			<table width="70%"  border="1" style="border: 1px solid #ddd">
				...
				<tr height= "40">
					...
					<td width="480" colspan="3"><textarea name="content" id="ir1" style="width: 100%; height: 412px;">${bean.content}</textarea></td>
				</tr>
				...
				<tr height= "40">
					<td colspan="4" align="center">
						...
						<input id="save" type="submit" value="글수정">&nbsp;&nbsp;
