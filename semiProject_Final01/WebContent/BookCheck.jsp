...
<body>
	...
	<section>
		<br>
			<div>
				<form name="bookForP" action="/semiProject_Final/bookUpd.do" method="post" onsubmit="return confirm('변경하시겠습니까?')">
					<h2 style="color: dodgerblue;"><span class="fas fa-calendar-alt">&nbsp;예약 내역</h2>
					<br>
		    		<table border="1" align="center" style="width: 220px; padding-left: 5px;">
		      			<tr>
				        	<td>날짜</td>
				        	<td><input type="date" name="bookDate" id="bookDate" value="${bookCheck.bookDate }"></td>
				      	</tr>
				      	<tr>
				        	<td>시간</td>
				        	<td>
				        		<c:choose>
				        			<c:when test="${bookCheck.bookTime eq '오전' }">
						        	...
						        	<c:otherwise>
						        		<input type="radio" name="bookTime" id="bookTime" value="오전">오전&nbsp&nbsp
						        		<input type="radio" name="bookTime" id="bookTime" value="오후" checked>오후
						        	</c:otherwise>
					        	</c:choose>
					        </td>
				      	</tr>
					...
					<table border="1" align="center">
						...
						<tr>
							<c:choose>
								<c:when test="${bookCheck.drName eq '김재윤' }">
								...
								<c:otherwise>
									<td><img src="image/doctor1.png" width="120" height="150"><br>
										<input type="radio" class="drName" name="drName" value="김재윤">김재윤 원장</td>
									<td><img src="image/hello2.png" width="120" height="150"><br>
										<input type="radio" name="drName" value="박병우" checked>박병우 원장</td>
								</c:otherwise>
							</c:choose>
						</tr>
					</table>
					...
					<table border="1" style="text-align: left;" align="center">
						...
						<tr>
							<td colspan="2">기존 값 : 
								<b><input type="text" style="border: hidden; color: #000063;" value="${bookCheck.bookItem }" readonly></b>
							</td>
						</tr>
						<tr>
					...
					<table align="center">
						<tr>
					    	<td><input type="submit" class="btn" value="변경하기">
					    </tr>
				    </table>
