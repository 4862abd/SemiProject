...
<body>
	...
	<section class="login-form">
		<div class="log">
			<form action="/semiProject_Final/userPwUpd.do" method="post" onsubmit="return check()">
			<h1 style="color: dodgerblue;"><b><span class="fas fa-question-circle"> 비밀번호<br> 변경</b></h1>
				<div class="int-area">
					<input type="text" name="userId" id="userId" autocomplete="off" placeholder="아이디 확인" required>
				</div>
				<div class="int-area">
					<input type="text" name="userPw" id="userPw" autocomplete="off" placeholder="변경할 비밀번호" required>
				</div>
				<div class="btn-area">
					<button id ="btn" type="submit" style="margin-bottom: 50px;">변경하기</button>
				</div>
			</form>
		</div>
		<script>
